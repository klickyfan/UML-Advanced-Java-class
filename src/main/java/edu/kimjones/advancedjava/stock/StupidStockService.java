...
/**
 * This class models a stupid stock service that always returns a stock quote with price 100.00.
 *
 * @author Kim Jones
 */
public class StupidStockService implements StockService {
    ...
    /**
     * This method gets a stock quote (supposedly containing the current price, but for this exercise really always
     * containing 100.00) for the company indicated by the given symbol.
     *
    ...
    /**
     * This method gets a stock quote (supposedly containing the current price, but for this exercise really always
     * containing 100.00) for the company indicated by the given symbol on the given date
     *
     * @param symbol    a stock symbol of a company, e.g. "APPL" for Apple
     * @param date      a date
     * @return          a stock quote (containing the current price) for the company with the given symbol
