...
/**
 * This class is used to signal a problem getting a list of objects from a database.
 */
public class DatabaseGetListException extends Exception {
     ...
     */
    public DatabaseGetListException(String message) { super(message); }
     ...
     */
    public DatabaseGetListException(String message, Throwable cause) {
        super(message, cause);
    }
}