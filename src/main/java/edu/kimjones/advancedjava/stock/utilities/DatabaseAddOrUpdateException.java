...
/**
 * This class is used to signal a problem adding or updating an object to/in a database.
 */
public class DatabaseAddOrUpdateException extends Exception {
     ...
     */
    public DatabaseAddOrUpdateException(String message) { super(message); }
     ...
     */
    public DatabaseAddOrUpdateException(String message, Throwable cause) {
        super(message, cause);
    }
}